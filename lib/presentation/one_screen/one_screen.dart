...
import 'package:gunwoong_s_application1/presentation/k1_dialog/k1_dialog.dart';
...
class OneScreen extends StatelessWidget {
  ...
  Widget _buildWidgetRow(BuildContext context) {
    return Padding(
        padding: EdgeInsets.only(left: 27.h, right: 18.h),
        child: Row(
            ...
            children: [
              Padding(
                  ...
                  child: Text("피크닉 김밥말기", style: theme.textTheme.titleLarge)),
              Container(
                  height: 28.v,
                  width: 29.h,
                  margin: EdgeInsets.only(bottom: 2.v),
                  decoration: BoxDecoration(color: appTheme.deepPurpleA700))
            ]));
  }
  ...
  /// Displays a dialog with the [K1Dialog] content.
